...
@Component({
  selector: 'app-coaches-map-sidebar',
  templateUrl: './coaches-map-sidebar.component.html',
  styleUrls: ['./coaches-map-sidebar.component.scss']
})
export class CoachesMapSidebarComponent implements OnInit{
  ...
  setInfo(marker: { profile_link: string; doc_name: string; image: string; address: string; }) {
    const content =
