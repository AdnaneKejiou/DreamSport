...
import { coachBooking } from 'src/app/shared/model/page.model';
...
export class CanceledComponent {
  ...
  constructor(
    ...
    this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
      if (this.router.url == this.routes.coachCanceled) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getCoachBookingCanceled().subscribe((apiRes: apiResultFormat) => {
      this.tableData = [];
