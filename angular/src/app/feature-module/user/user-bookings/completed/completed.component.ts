...
import { DataService, apiResultFormat,bookings,pageSelection, routes} from 'src/app/core/core.index';
...
export class CompletedComponent {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getuserCompleted().subscribe((apiRes: apiResultFormat) => {
      this.tableData = [];
